...
export declare function observable<Value = any, Context = null, Meta = null>(value: Value, options?: Omit<ICellOptions<Value, Context, Meta>, 'pull' | 'value'>): Cell<Value, Context, Meta>;
